...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if(turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog(null, "Player One Name", "SKRRTT", JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null, "Player Two Name", "SKRREE", JOptionPane.QUESTION_MESSAGE);
            ...
            twoFightMenu = new Menu("fight", "Tackle \n Thunderbold", 24, Color.BLACK, Color.WHITE, Color.BLACK, Color.WHITE, new FightCommands());       
        ...
        if(turnNumber == 1)
        {
            ...
            showText("player ones turn",getHeight()/2, getWidth()/2);
        }
        //TODO (22): Otherwise...
        else
        {
            ...
            showText("player twos turn", getHeight()/2, getWidth()/2);
        }
